...
public class JanelaProva extends JanelaAbstrata {
	 ...
	 * Create the frame.
	 */
	public JanelaProva(CtrlAbstratoProva ctrl, boolean habilitarProcura) {
		super(ctrl);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ctrl.iniciarIncluirProva();
			}
		});
		btnCadastrar.setBounds(41, 28, 156, 74);
		contentPane.add(btnCadastrar);
		
		JButton btnAlterar = new JButton("Alterar Prova");
		...
		JButton btnDeletar = new JButton("Deletar Prova");
		...
		JLabel lblId = new JLabel("ID Prova");

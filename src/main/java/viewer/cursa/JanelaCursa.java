...
public class JanelaCursa extends JanelaAbstrata {
	 ...
	 * Create the frame.
	 */
	public JanelaCursa(CtrlAbstratoCursa ctrl, boolean habilitarProcura) {
		super(ctrl);
		...
		JButton btnCadastrar = new JButton("Cadastrar Cursa");
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CtrlPrograma ctrl = (CtrlPrograma)getCtrl();
				ctrl.iniciarIncluirCursa();
			}
		});
		btnCadastrar.setBounds(41, 28, 156, 74);
		contentPane.add(btnCadastrar);
		
		JButton btnAlterar = new JButton("Alterar Cursa");
		...
		JButton btnDeletar = new JButton("Deletar Cursa");
		...
		JLabel lblId = new JLabel("ID Cursa");
